...
{    
    ...
    public function testAddRuleThrowsLogicException()
    {
        ...
        $this->formValidator->addRule(Validator::RuleRequired, "required!", function() { });
    }
    ...
    {
        $this->formValidator->addField("email", "test@test.com", [Validator::RuleRequired]);
        $result = $this->formValidator->validate();
        $this->assertEquals($result, []);
    }
    ...
    {
        $this->formValidator->addField("email", "testtest.com", [Validator::RuleValidEmail]);
        $result = $this->formValidator->validate();
    ...
    {
        $this->formValidator->addField("email", "", [Validator::RuleValidEmail, Validator::RuleRequired]);
